    ...
    return (
        <SafeAreaView style={{flex: 1, backgroundColor: 'white', position: 'relative'}}>
            ...
            <View style={{gap:12, backgroundColor:"blue",paddingHorizontal: "20%", backgroundColor:"white", alignItems:'center'}}>
                ...
                <View>
                    <Image source={require("../../assets/images/three.png")} resizeMode={"contain"} style={{width: 40, height: 40}}/>
                </View>
                <View style={{justifyContent:'center', alignItems:"center", gap:20}}>
                    <Text style={{fontFamily:'sf-semiBold', fontSize:14}}>Ease your search</Text>
                    <Text style={{fontFamily:'sf-light', fontSize:17}}>
                        Go through our vast collection of available sshousing space you can move into personally or with family.
                    </Text>
                </View>
            </View>
            <View style={{gap:18}}>
                <View style={{alignItems:'center' }}>
                    <LinearGradient
                        ...
                        style={{padding:17, borderRadius:50, width:250, alignItems:'center'}}
                            >
                        <TouchableOpacity onPress={() => navigation.navigate('signloading')}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('onboardtwo')} style={{alignItems:"center"}}>
